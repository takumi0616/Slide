...
/* 距離指標の比較スライドの画像を少し小さく */
section.metric-compare .fig-wrap { width: 320px !important; max-width: 320px !important; }
@media print {
  section.metric-compare .fig-wrap { width: 320px !important; max-width: 320px !important; }
}
  ...
  <tr style="vertical-align: top;">
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        ...
        <div class="figcaption">1991-01-09</div>
      </div>
    </td>
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19990728.png" alt="1999-07-28">
        <div class="figcaption">1999-07-28</div>
      </div>
    </td>
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19910819.png" alt="1991-08-19">
        <div class="figcaption">1991-08-19</div>
      </div>
    </td>
  </tr>
</table>

<h3 class="center-title">距離関数による数値比較</h3>
...
<div class="bubble">
サブタイプのあるラベルについては，重要な要素がどこにあるかで区別される
</div>
