...
<div class="bubble">
基本的で計算が高速だが，単純な点ごとの差の総和であるため構造的な特徴（前線・渦度など）を無視する
</div>
...
<div class="bubble">
S1 は「勾配の形」を比較する距離であり，気圧勾配の大きさと向きの違いから，パターン形状の一致度を測る
</div>
  ...
  <tr style="vertical-align: top;">
    <td style="width: 25%; text-align: center; padding: 2px 4px;">
      <div class="fig-wrap">
        ...
        <div class="figcaption">A（基準）：西高東低冬型（1991-01-09）</div>
      </div>
    </td>
    <td style="width: 25%; text-align: center; padding: 2px 4px;">
      <div class="fig-wrap">
    ...
    <td style="width: 25%; text-align: center; padding: 2px 4px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19990728.png" alt="1999-07-28">
        <div class="figcaption">C：南高北低夏型（1999-07-28）</div>
      </div>
    </td>
    <td style="width: 25%; text-align: center; padding: 2px 4px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19910819.png" alt="1991-08-19">
        <div class="figcaption">D：南方海上の台風（1991-08-19）</div>
      </div>
    </td>
  </tr>
</table>
...
| 手法名    |  値域  |     A-B |      A-C |      A-D |
| :-------- | :----: | ------: | -------: | -------: |
| Euclidean |  0〜   | 844.924 | 2442.762 | 2492.191 |
| S1        | 0〜200 |  72.482 |  114.130 |  108.485 |
| SSIM5     |  0〜1  |   0.803 |    0.864 |    0.991 |
| KAPPA     |  0〜1  |   0.432 |    0.511 |    0.516 |
