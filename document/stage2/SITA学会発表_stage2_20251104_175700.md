...
- 構造評価の不足
- 解釈性の課題
- 例：従来の SOM 研究 [Kohonen, 1990; Philippopoulos et al., 2014; Jiang et al., 2013]

**本研究の着眼点：** <span class="marker">構造類似度指標を SOM に統合</span>する．また，メドイド出力による<span class="marker">解釈性の課題の解決</span>
...
- SOM に構造類似度指標（SSIM, S1, KAPPA）を統合することで，  
  **気圧配置の構造的特徴をより忠実に分類可能**
- 特に **S1+KAPPA** により，  
  勾配と曲率の両面から気圧場の特徴を捉え，  
  台風型などの**閉じた構造の識別性能が向上**
- True Medoid 表現により，  
  **実データに基づく解釈性の高い分類結果**を得る

<div class="bubble">
本研究は「構造を理解する SOM」を目指す
</div>
