...
<!-- _header: 既存手法の課題 ＆ 本発表の主張 -->

### 教師あり学習（SVM [木村ら，2009]）

- 人手でラベル付けするコストが高い
  - 気象予報士ごとのラベル付の誤差が大きい
  - 1 つ 1 つの事例について詳細に分析する必要がある

### 教師なし学習（SOM）[Kohonen, 1990; Philippopoulos et al., 2014; Jiang et al., 2013]

- ユークリッド距離の限界
  - 一部の気圧配置において識別能力が低い（台風など）
- 解釈性の課題（Centroid 型）

### 本発表の主張

1. 既存の距離関数では表現力の低い気圧配置について，改善する<span class="marker">新たな距離関数の提案</span>[提案手法 1，2]

2. SOM の結果の評価についても問題があるため，<span class="marker">新たな評価指標を提案</span>[提案手法 3]
...
| :-------- | :---------: | ------------------------------------: | --------------------------: | -------------------------------------: |
| Euclidean |    0 〜     |                               844.924 |                    2251.393 | <span class="cell-bad">1582.296</span> |
| S1        | 0 〜 約 200 |                                72.482 |                      99.117 |   <span class="cell-bad">86.049</span> |
| SSIM5     |   0 〜 1    |                                 0.803 |                       0.971 |    <span class="cell-bad">1.000</span> |
| KAPPA     |   0 〜 1    | <span class="cell-good"> 0.432</span> |                       0.503 |  <span class="cell-good"> 0.442</span> |
