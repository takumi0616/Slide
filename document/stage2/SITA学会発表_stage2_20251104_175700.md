...
section.examples-6up .fig-wrap { width: 320px !important; max-width: 320px !important; }
@media print {
  section.examples-6up .fig-wrap { width: 320px !important; max-width: 320px !important; }
}
...
<div class="figcaption">図A，西高東低冬型（1991-01-09）</div>
...
- 海面更正気圧（Sea Level Pressure, SLP）
  ...
  - 気圧は日本各地や航行中の船を通して観測される
  - 観測地点の標高や気温の影響を取り除き、全地点を海面高度に補正した気圧
...
- 教師データの作成が困難
  ...
  - 気圧配置のようなデータでは「境界付近（どちらとも言えない事例）」が多い
  - 過学習や，本質的でない特徴の学習につながる

**例：SVM [木村ら，2009]**

- 上記の先行研究，および本研究で使用されるラベルデータについて
...
- 個々のデータは 60 点の精度でも，**集団の多数決をとることでノイズを低減**
- 一定の妥当性を担保できる
  ...
  <tr style="vertical-align: top;">
    <td style="width: 25%; text-align: center; padding: 2px 4px;">
      <div class="fig-wrap">
        ...
        <div class="figcaption">A：西高東低冬型（1991-01-09）</div>
      </div>
    </td>
    <td style="width: 25%; text-align: center; padding: 2px 4px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19910104.png" alt="1991-01-04">
        <div class="figcaption">B：西高東低冬型（1991-01-04）</div>
      </div>
    </td>
    <td style="width: 25%; text-align: center; padding: 2px 4px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19940919.png" alt="1994-09-19">
        <div class="figcaption">C：本州を過ぎた台風（1994-09-19）</div>
      </div>
    </td>
    <td style="width: 25%; text-align: center; padding: 2px 4px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19990925.png" alt="1999-09-25">
        <div class="figcaption">D：本州を過ぎた台風（1999-09-25）</div>
      </div>
    </td>
  </tr>
</table>
...
| :-------- | :---------: | ------------------------------------: | -------------------------------------: | --------------------------: |
| Euclidean |    0 〜     |                               844.924 | <span class="cell-bad">1582.296</span> |                    2251.393 |
| S1        | 0 〜 約 200 |                                72.482 |   <span class="cell-bad">86.049</span> |                      99.117 |
| SSIM5     |   0 〜 1    |                                 0.803 |    <span class="cell-bad">1.000</span> |                       0.971 |
| KAPPA     |   0 〜 1    | <span class="cell-good"> 0.432</span> |  <span class="cell-good"> 0.442</span> |                       0.503 |
...
<span class="marker">ノード内総距離が最小となる実サンプルを選択</span>（cf. Winderlich et al., 2024）
...
<table class="layout-table" style="width: 100%;">
  <tr style="vertical-align: top;">
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19910109.png" alt="西高東低冬型（1）">
        <div class="figcaption">1. 西高東低冬型（1991-01-09）</div>
      </div>
    </td>
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19941001.png" alt="気圧の谷型（2A）">
        <div class="figcaption">2A. 気圧の谷型（1994-10-01）</div>
      </div>
    </td>
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19920506.png" alt="移動性高気圧型（3A）">
        <div class="figcaption">3A. 移動性高気圧型（1992-05-06）</div>
      </div>
    </td>
  </tr>
  <tr style="vertical-align: top;">
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        ...
        <div class="figcaption">4A. 前線型（1993-07-07）</div>
      </div>
    </td>
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19990728.png" alt="南高北低夏型（5）">
        <div class="figcaption">5. 南高北低夏型（1999-07-28）</div>
      </div>
    </td>
    <td style="width: 33.33%; text-align: center; padding: 2px 6px;">
      <div class="fig-wrap">
        <img src="../images/slp_anom_19910819.png" alt="台風型（6A）">
        <div class="figcaption">6A. 台風型（1991-08-19）</div>
      </div>
    </td>
  </tr>
</table>
...
- そもそもの**ラベル信頼度が約 60%**程度
- 「ラベルなし」を含むべき曖昧なデータが多数存在
- **100%を目指すことには意味がない**（むしろ過学習の恐れ）

**✅ 重視する評価ポイント**

1. **既存手法との相対比較**：相対的に性能が向上しているか
2. **安定性**：複数試行での安定した分類が可能か
3. **可視化結果の妥当性**：SOM マップで気象学的に妥当な配置になっているか
4. **総合評価**：ラベルの数値スコア（Macro Recall など）は一指標。メドイド可視化・NodewiseMatchRate・安定性・クラス別傾向を総合判断

<div class="bubble">
本研究では，数値だけでなく<span class="marker">SOMマップの可視化による質的評価</span>を重視する
</div>
...
**青強調**：詳しい考察を行う手法，**緑色強調**：最も良いスコア，**黄色強調**：次点で良いスコア，**赤色強調**：低いスコア
...
- 特に**台風ラベルのノード**を安定的に出現させることに成功
- 気象学的に妥当な配置が実現されている

**🔧 成功の理由**

- S1（気圧勾配）と KAPPA（曲率）の相補性
...
<div class="figcaption">図7， 移動性高気圧型[3A]の天気図（1992-05-06）</div>
