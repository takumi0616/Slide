...
高次元データを低次元マップに写像する教師なし学習手法 [Kohonen, 1990]

### 学習プロセス

1. **初期化：** $M = m_x \times m_y$ 個のノードを 2 次元格子上に配置
2. **BMU 探索：** 各入力 $x_i$ に対して最良一致ユニットを決定  
...
- Philippopoulos, K., Deligiorgi, D., and Kouroupetroglou, G. (2014). Performance comparison of self-organizing maps and k-means for atmospheric circulation classification. (2014).
